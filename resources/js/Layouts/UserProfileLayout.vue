...
<template>
    <AuthenticatedLayout>
        <div class="max-w-[768px]  mx-auto h-full overflow-auto">
            ...
            <div class="border-t">
                <TablItem text="Posts" :selected="false"/>
                <TablItem text="Followers" :selected="false"/>
                <TablItem text="Followings" :selected="false"/>
                <TablItem text="Photos" :selected="false"/>
                <TablItem text="My Profile" :selected="false"/>
