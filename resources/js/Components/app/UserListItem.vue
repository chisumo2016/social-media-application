    ...
    <div class="mb-3 bg-white transition-all  border-2 border-transparent hover:border-indigo-500">
        ...
        <div  class="flex items-center gap-2 py-2 px-2">
            ...
            <Link  :href="route('profile', user.username)">
                <img :src="user.avatar_url" alt="" class="w-[32px] rounded-full">
            </Link>
            ...
            <div class="flex justify-between flex-1">
                ...
                <div v-if="forApprove" class="flex gap-1">
                    ...
                    <button
                        class="text-xs py-1 px-2 rounded bg-red-500 hover:bg-emerald-600 text-white"
                ...
                <!-- Drop Down Role -->
                    ...
                    <!-- <pre> {{ user }}</pre>-->
                        <select
                            ...
                            class="rounded-md border-0 py-1
                        ...
                        <button
                            ...
                            class="text-xs
                                    ...
                                    bg-gray-700
                                    hover:bg-gray-800
                                    text-white  ml-3 disabled:bg-gray-500">
                            Delete
                        </button>
                    </div>
